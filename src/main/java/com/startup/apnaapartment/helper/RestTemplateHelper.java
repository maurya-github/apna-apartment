...
public class RestTemplateHelper {
  ...
  public <T, R> T postForEntity(Class<T> clazz, String url, R body,
    ...
    HttpEntity<R> request =
        headers != null ? new HttpEntity<>(body, headers) : new HttpEntity<>(body);
    ResponseEntity<String> response = restTemplate
        .postForEntity(url, request, String.class, uriVariables);
    JavaType javaType = objectMapper.getTypeFactory().constructType(clazz);
    return readValue(response, javaType);
  }
  ...
  public <T, R> T putForEntity(Class<T> clazz, String url, R body, Object... uriVariables) {
    ...
    ResponseEntity<String> response = restTemplate
        .exchange(url, HttpMethod.PUT, request, String.class, uriVariables);
    JavaType javaType = objectMapper.getTypeFactory().constructType(clazz);
    return readValue(response, javaType);
  }
